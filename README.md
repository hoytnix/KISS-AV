...
## KISS AV v2.2.2 Enterprise Edition

### Downloads

* **[Windows x64 Installer (.exe)](https://github.com/hoytnix/KISS-AV/releases/download/v2.2.2/kiss-daemon_2.2.2_x64-setup.exe)**
* **[macOS aarch64 Installer (.dmg)](https://github.com/hoytnix/KISS-AV/releases/download/v2.2.2/KissDaemon_2.2.2_aarch64.dmg)**
* **[Linux amd64 Package (.deb)](https://github.com/hoytnix/KISS-AV/releases/download/v2.2.2/kiss-daemon_2.2.2_amd64.deb)**
* **[Linux arm64 Package (.deb)](https://github.com/hoytnix/KISS-AV/releases/download/v2.2.2/kiss-daemon_2.2.2_arm64.deb)**
